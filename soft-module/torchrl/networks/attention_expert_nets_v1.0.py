...
class MLPBaseAE(nn.Module):
    def __init__(self, input_shape, hidden_shapes, expert_nums, task_nums, expert_hidden_shapes, tower_hidden_shapes,
                 attention_shapes, activation_func=F.relu, init_func=init.basic_init, last_activation_func=None,
                 flag=None, expert_id=None, v_id=None, q_id=None, k_id=None):
        super().__init__()
        self.flag = flag
...
class NetAE(nn.Module):
    def __init__(
        ...
        for i in range(self.n):
            ...
            self.attention_q_list.append(
                base_type(activation_func=activation_func, expert_nums=self.n, flag='attention_q', q_id=i, **kwargs))
    ...
    def forward(self, x, task_id):
        ...
        for i in range(self.n):
            ...
            q = self.attention_q_list[i](task_id)
            expkq = torch.dot(k, q)
