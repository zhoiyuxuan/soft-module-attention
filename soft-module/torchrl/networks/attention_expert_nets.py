...
class NetAE(nn.Module):
    def __init__(
        ...
        self.attention_q = base_type(activation_func=activation_func, expert_nums=self.n, flag='attention_q',**kwargs)
        self.activation_func = activation_func
    ...
    def forward(self, x, task_id):
        ...
        # 3 tower network
        out = self.tower(vs[1]*alphas[1].unsqueeze(-1)+vs[2]*alphas[2].unsqueeze(-1)+vs[0]*alphas[0].unsqueeze(-1))
