...
from torchrl.algo import MTSACAE
...
def experiment(args):
    ...
    params['net']['base_type'] = networks.MLPBaseAE
    ...
    pf = networks.GuassianContPolicyAE(
        input_shape=env.observation_space.shape[0],
        output_shape=2 * env.action_space.shape[0],
        **params['net'])
    qf1 = networks.FlattenNetAE(
        input_shape=env.observation_space.shape[0] + env.action_space.shape[0],
        output_shape=1,
        **params['net'])
    qf2 = networks.FlattenNetAE(
        input_shape=env.observation_space.shape[0] + env.action_space.shape[0],
        output_shape=1,
        **params['net'])
